 ...
 *   2. Recent pens (last 3)
 *   3. Recent inks (last 3)
...
function EmptyPenRow() {
  return (
    <View style={styles.row} testID="home-pens-empty">
      <Text variant="small" color="textMuted">
        No pens yet. Add your first from the Pens tab.
      </Text>
    </View>
  );
}

function EmptyInkRow() {
  return (
    <View style={styles.row} testID="home-inks-empty">
      <Text variant="small" color="textMuted">
        No inks yet. Add your first from the Inks tab.
      </Text>
    </View>
  );
}
